...
kind(FermionGf), mesh_id(get_mesh_id<imtime>()), norm(1.0),
...
kind(FermionGf), mesh_id(get_mesh_id<imfreq>()), norm(1.0),
...
kind(FermionGf), mesh_id(get_mesh_id<legendre>()), norm(1.0),
rhs(input_data_r_t()), error_bars(input_data_r_t()) {
