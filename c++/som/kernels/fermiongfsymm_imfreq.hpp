...
// Kernel: symmetric fermionic GF, Matsubara frequencies
template <>
class kernel<FermionGfSymm, triqs::mesh::imfreq>
   : public kernel_base<kernel<FermionGfSymm, triqs::mesh::imfreq>,
...
public:
  ...
  constexpr static observable_kind kind = FermionGfSymm;
