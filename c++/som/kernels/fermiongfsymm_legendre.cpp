...
#include "fermiongfsymm_legendre.hpp"
...
////////////////////////////////////////////////
// kernel<FermionGfSymm, legendre>::evaluator //
////////////////////////////////////////////////

kernel<FermionGfSymm, legendre>::evaluator::evaluator(long l, double x0_start)
...
double kernel<FermionGfSymm, legendre>::evaluator::operator()(double x) const {
...
void kernel<FermionGfSymm, legendre>::apply(rectangle const& rect,
...
double kernel<FermionGfSymm, legendre>::Lambda(long l, double Omega) const {
  return -evaluators[l / 2](Omega * beta / 2);
}

std::ostream& operator<<(std::ostream& os,
                         kernel<FermionGfSymm, legendre> const& kern) {
  os << R"(A(ϵ) -> G_{sym}(ℓ), )";
