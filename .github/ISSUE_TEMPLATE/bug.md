---
name: Bug report
about: Create a report to help us improve SOM
title: Bug report
labels: bug
...
* Please check that a similar issue isn't already filed: https://github.com/krivenko/som/issues
...
```bash
python -c "from som.version import *; show_version(); show_git_hash();"
```
