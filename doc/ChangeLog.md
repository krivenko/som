...
- Port to [TRIQS 4.0](https://github.com/TRIQS/triqs/releases/tag/4.0.0).
  TRIQS 3.x is no longer supported. Building SOM now requires CMake 3.20 and
  a C++ compiler supported by TRIQS 4.0 (clang >= 19 or gcc >= 14).
- Python scripts must now import Green's function containers from
